...
public class _array_06__jsp extends com.caucho.jsp.JavaPage
{
...
//    String output2="";
    if(m.isPost()) {
        ...
        //\uc785\ub825\ubc1b\uc740 \ubb38\uc790\uc5f4
        String inputArray = f.get("array1");
//        m.jsAlert(inputArray1);

        //\uc785\ub825\ubc1b\uc740 \ubb38\uc790\uc5f4\uc744 \uac70\uafb8\ub85c \ubcc0\ud658
        String reversed = new StringBuffer(inputArray).reverse().toString();
//        m.jsAlert(reversed);
        ...
        for (int i = 0; i < arrint.length; i++){
            isPrime(arrint[i]);
            outputArr.add(arrint[i]);
        }

        //ArrayList \ub97c \uc2a4\ud2b8\ub9c1\uc73c\ub85c \ubcc0\ud658 - \ucd9c\ub825
...
//    p.setVar("output2", output2);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/algorithm/array_6.jsp"), 28584020355226828L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
