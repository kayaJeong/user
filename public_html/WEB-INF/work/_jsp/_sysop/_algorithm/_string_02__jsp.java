...
public class _string_02__jsp extends com.caucho.jsp.JavaPage
{
...
p.setVar("SYS_TITLE", "[\uad00\ub9ac\uc790] enter \uc624\ud508 \ub354 \uc774\ub7ec\ub2dd \uc0ac\uc774\ud2b8");
    ...
    String output =""; //\ucd9c\ub825
    if(m.isPost()){
        String str1 = f.get("text3"); //\ubb38\uc790\uc5f4 \uc785\ub825\ubc1b\uae30
        char tmp;

        for(int i = 0 ; i < str1.length(); i++){
            tmp = str1.charAt(i); //\ud55c\uae00\uc790\uc529 tmp\uc5d0 \ub123\uae30

            if(Character.isUpperCase(tmp) == true){ //\ub300\ubb38\uc790
                output += str1.valueOf(tmp).toLowerCase(); //\ub0b4\uc7a5\ud568\uc218\ub85c \uc18c\ubb38\uc790\ub85c \ubcc0\ud658

            } else if (Character.isLowerCase(tmp) == true) { //\uc18c\ubb38\uc790
                output += str1.valueOf(tmp).toUpperCase();
            } else { //\uadf8\uc678
                output += (char)tmp; //\uadf8\ub300\ub85c
            }
        }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/algorithm/string_2.jsp"), 2860036297512570472L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
