...
public class _array_03__jsp extends com.caucho.jsp.JavaPage
{
...
p.setVar("SYS_TITLE", "[\uad00\ub9ac\uc790] enter \uc624\ud508 \ub354 \uc774\ub7ec\ub2dd \uc0ac\uc774\ud2b8");
    ...
    if(m.isPost()){
        ...
        m.jsAlert(inputArray1);
        m.jsAlert(inputArray2);

        //\uc785\ub825\ubc1b\uc740 \ubb38\uc790\uc5f4\uc744 \uacf5\ubc31\uc744 \uae30\uc900\uc73c\ub85c \ub098\ub204\uae30
        String[] arr1 = inputArray1.split(" "); //A
        String[] arr2 = inputArray2.split(" "); //B
        ...
        for(int i = 0 ; i < arr1.length; i++){
            //\ubb38\uc790\ub97c \uc22b\uc790\ub85c \ubc14\uafb8\uace0
            //\uac12\uc744 \ube44\uad50
            if((Integer.parseInt(arr1[i])) - (Integer.parseInt(arr2[i]))  == -1 ) {
                // b\uac00 \uc774\uae40
                outputArr.add("B");
            } else if ((Integer.parseInt(arr1[i])) - (Integer.parseInt(arr2[i])) == -2) {
                //a \uac00 \uc774\uae40
                outputArr.add("A");
            } else if ((Integer.parseInt(arr1[i])) - (Integer.parseInt(arr2[i])) == 1) {
                //a \uac00 \uc774\uae40
                outputArr.add("A");
            } else if ((Integer.parseInt(arr1[i])) - (Integer.parseInt(arr2[i])) == 1) {
                //a \uac00 \uc774\uae40
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/algorithm/array_3.jsp"), 432639847082078004L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
