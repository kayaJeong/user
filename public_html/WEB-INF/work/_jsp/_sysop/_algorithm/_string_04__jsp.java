...
public class _string_04__jsp extends com.caucho.jsp.JavaPage
{
...
p.setVar("SYS_TITLE", "[\uad00\ub9ac\uc790] enter \uc624\ud508 \ub354 \uc774\ub7ec\ub2dd \uc0ac\uc774\ud2b8");
    ...
    if(m.isPost()){
        ...
        //\uc785\ub825\ubc1b\uc740 String
        String str = f.get("text5");
        String str2 = f.get("text6");
        String str3 = f.get("text7");
        m.jsAlert(str);

        // \uac01 \uc2a4\ud2b8\ub9c1\uc744 char\ub85c \ubc14\uafb8\uace0 \uadf8 \uae38\uc774\ub9cc\ud07c
       char [] char1 = str.toCharArray();
       char charoutput [] = new char[char1.length];

       for (int i = char1.length; i < char1.length; i--){
           charoutput[i] = char1[i];
       }
        output = String.valueOf(charoutput);
    }

    p.setLayout(ch);
    p.setBody("algorithm.string_4");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/algorithm/string_4.jsp"), -460575696861533209L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
