...
public class _twopointer_01__jsp extends com.caucho.jsp.JavaPage
{
...
p.setVar("SYS_TITLE", "[\uad00\ub9ac\uc790] enter \uc624\ud508 \ub354 \uc774\ub7ec\ub2dd \uc0ac\uc774\ud2b8");
    ...
    if(m.isPost()){
        //\uc785\ub825\ubc1b\uc740 \uccab\ubc88\uc9f8 \ubc30\uc5f4
        String arr1 = f.get("array1");

        //\uc785\ub825\ubc1b\uc740 \ub450\ubc88\uc9f8 \ubc30\uc5f4
        String arr2 = f.get("array2");


        //\uacf5\ubc31\uc744 \uae30\uc900\uc73c\ub85c \ubb38\uc790\uc5f4\uc744 \ub098\ub220\uc11c \ubc30\uc5f4\uc5d0 \ub123\uae30
        String [] array1 = arr1.split(" ");
        String [] array2 = arr2.split(" ");

        //\uc2a4\ud2b8\ub9c1 \ubc30\uc5f4 -> \uc778\ud2b8\ud615 \ubc30\uc5f4
        int[] array11 = new int[array1.length];
        int[] array22 = new int[array2.length];
        for(int i=0; i< array1.length; i++){
            array11[i] = Integer.parseInt(array1[i]);
        }
        for(int i=0; i< array2.length; i++){
            array22[i] = Integer.parseInt(array2[i]);
        }

        //\ud569\ud55c \ub450 \ubc30\uc5f4\uc744 \ub2f4\uc744 \uc0c8\ub85c\uc6b4 \ubc30\uc5f4 \uc120\uc5b8
        int [] arrayOutput = new int[array22.length + array11.length];

        //\ub450 \ubc30\uc5f4 \ud569\uce58\uae30
        System.arraycopy(array11, 0, arrayOutput, 0, array11.length);
        System.arraycopy(array22, 0, arrayOutput, array11.length, array22.length);
        ...
        for(int i =0; i< arrayOutput.length; i++){
            output += arrayOutput[i] +" ";
        }
    }

    p.setLayout(ch);
    p.setBody("algorithm.twopointer_1");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/algorithm/twopointer_1.jsp"), -2447614544247599153L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
