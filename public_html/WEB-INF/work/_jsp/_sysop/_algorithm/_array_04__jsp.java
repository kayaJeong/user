...
public class _array_04__jsp extends com.caucho.jsp.JavaPage
{
...
p.setVar("SYS_TITLE", "[\uad00\ub9ac\uc790] enter \uc624\ud508 \ub354 \uc774\ub7ec\ub2dd \uc0ac\uc774\ud2b8");
    ...
    if(m.isPost()){
        ...
        //\uc785\ub825\ubc1b\uc740 \ubb38\uc790\uc5f4-> \uc22b\uc790\ub85c \ubc14\uafb8\uae30
        int inputNum = Integer.parseInt(inputArray1);

        //\ucd9c\ub825\ud560 ArrayList \uc120\uc5b8
        ArrayList<Integer> outputArr = new ArrayList();

        //\ud53c\ubcf4\ub098\uce58 \uc218\uc5f4
        outputArr.add(new Integer(1));
        outputArr.add(new Integer(1));
        int sum = 0;
        for(int i = 2 ; i < inputNum; i++){

            sum = outputArr.get(i-1) + outputArr.get(i-2);
            outputArr.add(i,sum);
        }

        //ArrayList \ub97c String \uc73c\ub85c \ubcc0\ud658 - \ucd9c\ub825
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/algorithm/array_4.jsp"), -6626649330187672891L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
