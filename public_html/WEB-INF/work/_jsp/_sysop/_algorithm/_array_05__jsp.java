...
public class _array_05__jsp extends com.caucho.jsp.JavaPage
{
...
//        m.jsAlert(inputArray1);
        ...
        //\uc785\ub825\ubc1b\uc740 \ubb38\uc790\uc5f4-> \uc22b\uc790\ub85c \ubc14\uafb8\uae30 -> \uc774 \uc22b\uc790\ub9cc\ud07c for \ubb38 \ub3cc\ub9ac\uae30
        ...
        for (int i = 2; i < inputNum; i++) {
            if(arr[i] == 0 ){
                cnt++;
                for(int j = i; j<=inputNum; j=j+i){ //j+i \uc740 j\ub294 i\uc758 \ubc30\uc218\ub2c8\uae4c
                    arr[j] = 1;
                }
            }
        }
        output =Arrays.toString(arr);
        output2 = Integer.toString(cnt);
    }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/algorithm/array_5.jsp"), 8850762045037045672L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
