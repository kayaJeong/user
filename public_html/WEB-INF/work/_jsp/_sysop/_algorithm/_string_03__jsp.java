...
public class _string_03__jsp extends com.caucho.jsp.JavaPage
{
...
p.setVar("SYS_TITLE", "[\uad00\ub9ac\uc790] enter \uc624\ud508 \ub354 \uc774\ub7ec\ub2dd \uc0ac\uc774\ud2b8");
    ...
    String maxWordOutput="";
    if(m.isPost()){
        String str = f.get("text4"); //\ubb38\uc790\uc5f4 \uc785\ub825\ubc1b\uae30
        ...
        String maxWord="";
        int max = 0;
        int [] lenArr = new int[splitStr.length]; //\ubb38\uc790\uc5f4 \uae38\uc774\ub97c \ub2f4\uc744 \uc778\ud2b8\ud615 \ubc30\uc5f4 \uc120\uc5b8
        for(int i =0; i < splitStr.length; i++){ //\ubc30\uc5f4\uc758 \uc218\ub9cc\ud07c \ubc18\ubcf5
            lenArr[i] = splitStr[i].length(); //\uc22b\uc790 \ubc30\uc5f4\uc5d0 \uae38\uc774\ub9cc\ud07c \ub123\uae30
            if(lenArr[i] > max){ //\uc22b\uc790\uc640 \ucd5c\ub300\uac12 \ube44\uad50\ud574\uc11c \ud06c\uba74
                max = lenArr[i]; //\ucd5c\ub300\uac12\uc5d0 \ub123\uae30
                maxWord = splitStr[i]; //\ubb38\uc790\uc5f4\uc758 i\ubc88\uc9f8\uc758 \ubb38\uc790\ub97c \ub9e5\uc2a4\uc6d4\ub4dc\uc5d0 \ub123\uae30
            }
        } maxWordOutput=maxWord;
    }

    p.setLayout(ch);
    p.setBody("algorithm.string");
    p.setVar("maxWord", maxWordOutput);
    p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/algorithm/string_3.jsp"), 1440783003409844095L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
