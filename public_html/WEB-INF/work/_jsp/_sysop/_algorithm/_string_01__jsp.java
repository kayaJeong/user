...
public class _string_01__jsp extends com.caucho.jsp.JavaPage
{
...
p.setVar("SYS_TITLE", "[\uad00\ub9ac\uc790] enter \uc624\ud508 \ub354 \uc774\ub7ec\ub2dd \uc0ac\uc774\ud2b8");
    ...
    if(m.isPost()){
//        m.jsAlert("ggg");
        String str = f.get("text1");
        String str2 = f.get("text2");

        num = algoDao.countChar(str, str2);
    }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/algorithm/string_1.jsp"), -3641927210555369263L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
